...
class BenefitsAdapter : RecyclerView.Adapter<BenefitHolder>() {
    private val benefits = listOf(
            ...
            Benefit(R.drawable.ic_cloud_outline_black, "Store your files on the Sia network, the future of cloud storage"),
            Benefit(R.drawable.ic_money_white, "Pay less than traditional cloud storage"),
            Benefit(R.drawable.ic_lock_outline_white, "Have complete control and privacy over your files"),
            Benefit(R.drawable.ic_person_outline_black, "Participate in a blockchain marketplace"),
            Benefit(R.drawable.ic_code_black, "Support development"),
            Benefit(R.drawable.ic_free_breakfast_black, "All for less than the cost of your morning cup of coffee!"),
            Benefit(R.drawable.ic_money_white, "7 day free trial"),
            Benefit(R.drawable.ic_cancel_black, "Easily cancel at any time from Settings")
    )
    // TODO: want one describing redundancy and uptime
