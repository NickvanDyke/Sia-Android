...
class WalletFragment : Fragment(), IWalletView, SiadService.SiadListener {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        if (MainActivity.appTheme === MainActivity.Theme.AMOLED) {
            receiveButton.setBackgroundColor(resources.getColor(android.R.color.transparent))
            sendButton.setBackgroundColor(resources.getColor(android.R.color.transparent))
        }
